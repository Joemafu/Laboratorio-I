...
int main()
{
    ...
    do
    {
        ...
        case 1:
            ...
            {
                showMessage("El propietario se cargo con exito.\n");
                id++;
            }else{
                showMessage("Hubo un error al cargar el propietario.\n");
            }
            break;
        case 2:
            system("cls");
