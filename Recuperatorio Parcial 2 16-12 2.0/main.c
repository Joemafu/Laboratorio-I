...
int main()
{
    int i;
    float* floatArray;
    float* floatArrayLeido;

    floatArray=newArray();

    printf("Aca los cargo de atras para adelante y muestro:\n");
    ...
    printf("Aca los muestro pero ordenados:\n");
    mostrarArray(floatArray,3);


    printf("Aca lo agrando y lo vuelvo a mostrar:\n");
    ...
    *(floatArray+4)=0.4;
    ...
    printf("Aca lo escribo:\n");
    escribirArray(floatArray);

    printf("Aca lo leo y muestro la lectura:\n");
    floatArrayLeido=leerArray();

    mostrarArray(floatArrayLeido,5);
